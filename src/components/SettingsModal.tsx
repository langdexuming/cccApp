...
import {Bot, CheckCircle2, Cpu, FolderInput, GitBranch, Globe, Info, Key, Plus, RefreshCw, Save, Shield, Trash2, Users, X} from 'lucide-react';
...
type SettingsTab = ProviderType | 'collaboration' | 'git';
